...
public class BackgroundRenderer {
  ...
  private static final String SAMPLE_VERTEX_SHADER =
          "attribute vec4 a_Position;\n" +
                  ...
                  "}\n";
  private static final String SAMPLE_FRAGMENT_SHADER =
  ...
  public void createOnGlThread(Context context) throws IOException {
    ...
    int vertexShader =
        ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, SAMPLE_VERTEX_SHADER, 0);
    int fragmentShader =
        ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, SAMPLE_FRAGMENT_SHADER, 0);
  ...
  public void draw(@NonNull Frame frame) {
    ...
    if (frame.getTimestamp() == 0) {
      // Suppress sample.rendering if the camera did not produce the first frame yet. This is to avoid
